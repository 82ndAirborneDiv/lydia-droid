...
public class Constants {
    ...
    public static final String SC_SECTION_CONDITION_DETAILS_MORE_INFO = "Condition Details - More Info";
    ...
    public static final String SC_PAGE_TITLE_FULL_GUIDELINES = "Full Guidelines";
    public static final String SC_PAGE_TITLE_SEXUAL_HISTORY = "Sexual History";
    public static final String SC_PAGE_TITLE_TERMS = "Terms";
}
